...
class VideoFrameSegmentData(VideoData):
    ...
    def get_image_data(self, index):
        ...
        logging.debug(f"len(self.img_dir_ls) -- {len(self.img_dir_ls)}")
        img_dir = self.img_dir_ls[index]
        # 2024-07-25 01:22:04,554 - DEBUG - index -- 5711
        # 2024-07-25 01:22:04,554 - DEBUG - len(self.img_dir_ls) -- 9845
        logging.debug(f"img_dir -- {img_dir}")
        
        # img_dir 是某一个video的所有frame合集所在的temp
    ...
    def list_frames(img_dir):
        ...
        # This line uses glob.glob to find all .jpg files in the specified img_dir directory. It returns a list of paths to these image files.
