...
# python script/run_exp.py -c config/unified_frame_images/MOSE_09_hrnet.yaml

python script/run_exp.py -c config/unified_frame_images/MOSE_09_hrnet_Alia_test.yaml
